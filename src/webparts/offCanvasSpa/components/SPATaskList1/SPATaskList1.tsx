...
import { IOffCanvasSpaProps, ITask } from '../IOffCanvasSpaProps';
...
const SPATaskList1: React.FunctionComponent<IOffCanvasSpaProps> = (props) => {
    ...
    useEffect(() => {
        helperService.updateSiteTitle(props.context, "Task List")
    ...
    return (
        <div className={styles.offCanvasSpa}>
